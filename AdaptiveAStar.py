...
def computePath(open_list, closed_list, goal, expanded, counter, states, track_explored, adaptive = False):
...
def repeatedAdaptiveMain(grid_path, start, goal, larger_g = True, track_explored = None):
    ...
    while start_state != goal_state: # continue until start reaches
        ...
        ## adaptive A
        goal_distance = goal_state.g  # g(goal)
        for state in closed_list:
            state.h = goal_distance - state.g
