...
for i in range(1, num_grids + 1):
    ...
    path_smaller_g, expandeds, runtime_smaller_g = repeatedForwardMain(grid_filename, start, goal, False) ## repeatedAdaptiveMain, True
...
axes[1].set_title("Cell Expansion Comparison: Larger G vs. Smaller G")
axes[1].legend()
...
plt.tight_layout()
plt.savefig("graphics/largerVsSmaller.png")
plt.show()